...
class Game {
    ...
    constructor() {
        ...
        this.#waves = [
            { count: 10, interval: 1000 }, { count: 15, interval: 800 },
            { count: 20, interval: 600 }
        ];
        this.#currentWaveIndex = 0;
        this.#loadWave();

        console.log('Tower Defense (vanilla JS) - Fase 1 Iniciada!');
        this.#animate(0);
    }
    ...
    #drawUI() {
        ...
        this.#ctx.fillText(`Vida: ${this.#playerHealth}`, this.#canvas.width - 150, 80);
    ...
    #animate(timeStamp) {
        ...
        if (this.#gameState === 'playing') {
            ...
            if (this.#currentWaveIndex >= this.#waves.length && this.#enemies.length === 0) {
